...
function checkValidVal(val, elem) {

    
    var inpVal, maxVal, minVal;
    maxVal = parseInt(elem.max);
    minVal = parseInt(elem.min);
    inpVal = parseInt(val);
...
function getUserInput() {
    ...
    val1 = elem.value; 
    val1 = checkValidVal(val1, elem)
    var elem = document.getElementById('inp2');
    val2 = elem.value; 
    val2 = checkValidVal(val2, elem)
    var elem = document.getElementById('inp3');
    val3 = elem.value; 
    val3 = checkValidVal(val3, elem)
    var elem = document.getElementById('inp4');
    val4 = elem.value; 
    console.log(val4, elem.max, elem.min);
    val4 = checkValidVal(val4, elem)
    console.log(val4);
    val4 = val4/10;
...
console.log(orgX, orgY, smallCircleRad)
